...
Namespace Support
    ...
    Public Class LogEngine
        ...
        Private _registry As CHCServerSupport.Support.RegistryEngine
            ...
            Try
                ...
                If (messageType = "fatal") Then
                    ...
                    If Not IsNothing(_registry) Then
                        ...
                        _registry.addNew(RegistryEngine.RegistryData.TypeEvent.applicationError, content, _completeFileName)
